...
@section('title', 'Laporan Pemasukan Makanan')
@section('subtitle', 'Pantau dan ekspor data pemasukan makanan hotel')

@section('content')
<div class="breadcrumb">
    <a href="{{ route('admin.dashboard') }}">Admin Panel</a> <span>/</span> <span>Laporan Pemasukan Makanan</span>
</div>
...
<div class="stats-card mb-8">
    <h4 class="mb-6 flex items-center">
        ...
        Pemasukan Makanan Bulanan (12 Bulan Terakhir)
    </h4>
        ...
        <table class="min-w-full table-auto">
            <thead>
                <tr class="bg-gray-50">
                    ...
                    <th class="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Pemasukan Makanan</th>
                </tr>
            </thead>
...
<div class="stats-card">
    <h4 class="mb-4 flex items-center">
        ...
        Informasi Pemasukan Makanan
    </h4>
    <div class="text-sm text-gray-600 space-y-3">
        <p><i class="fas fa-utensils text-purple-500 mr-2"></i> Data pemasukan dihitung berdasarkan pesanan makanan yang telah dikonfirmasi</p>
        <p><i class="fas fa-calculator text-green-500 mr-2"></i> Perhitungan menggunakan total harga dari setiap pesanan yang berhasil</p>
        <p><i class="fas fa-calendar text-blue-500 mr-2"></i> Data bulanan mencakup 12 bulan terakhir dari tanggal saat ini</p>
